...
def upgrade():
    ...
    op.add_column('challenges', sa.Column('is_private', sa.Boolean(), nullable=False, server_default='0'))
    op.add_column('games', sa.Column('is_private', sa.Boolean(), nullable=False, server_default='0'))
